...
public class RegenerationArtifact {

    public static ItemStack artifact = new ItemStack(PlayerGUI.regenerationArtifact);
    ...
    public static void giveArtifact(Player player){
        ...
        strList.add(ChatColor.GREEN + "Permanent Regeneration Effect");
