...
public class StrengthArtifact {

    public static ItemStack artifact = new ItemStack(PlayerGUI.strengthArtifact);
    ...
    public static void giveArtifact(Player player){
        ...
        strList.add(ChatColor.GREEN + "Permanent Strength Effect");
